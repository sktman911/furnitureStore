      ...
      <div>
        <ul className="grid grid-cols-3 xl:grid-cols-4 gap-4 w-4/5 mx-auto py-10">
          <li className="text-left">
            ...
            <p className=" mt-16 text-gray-600 text-sm md:text-md 2xl:text-xl">
              400 University Drive Suite 200 Coral Gables,
            </p>
            <p className="text-gray-600 text-sm md:text-md 2xl:text-xl">FL 33134 USA</p>
          </li>

          <li className=" w-1/2 mx-auto text-left">
            <h2 className=" text-gray-600 pb-6 text-lg md:text-xl xl:text-xl">Links</h2>
            <ul>
          ...
          <li className=" w-1/2 mx-auto text-left">
            <h2 className=" text-gray-600 pb-6 text-lg md:text-xl xl:text-xl">Help</h2>
            <ul>
